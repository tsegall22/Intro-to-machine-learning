...
def compute_cost(X, y, theta):
    ...
    ###########################################################################
    J = 0.5 * (1 / len(y)) * np.sum(np.square(np.dot(X, theta) - y))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    return J
...
def gradient_descent(X, y, theta, alpha, num_iters):
    ...
    for i in range(num_iters):
        ...
        theta = theta - (alpha / len(y)) * np.dot((np.dot(X,theta) - y),X)
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def efficient_gradient_descent(X, y, theta, alpha, num_iters):
    ...
    for i in range(num_iters):
        theta = theta - (alpha / len(y)) * np.dot((np.dot(X,theta) - y),X)
        J_history.append(compute_cost(X, y, theta))
        if i > 0 and J_history[i-1] - J_history[i] <= delta:
            break
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def find_best_alpha(X, y, iterations):
    ...
    for alpha in alphas:
        alpha_dict[alpha] = efficient_gradient_descent(X, y, theta, alpha, iterations)[1][-1]
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    return alpha_dict
...
def generate_triplets(X):
    ...
    # TODO: Implement the function.                                           #
    ###########################################################################
    triplets = list(itertools.combinations(X.columns.values, 3))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    return triplets
...
def find_best_triplet(df, triplets, alpha, num_iter):
    ...
    for triplet in triplets:
        ...
        J = efficient_gradient_descent(X, y, theta, alpha, num_iter)[1][-1]
        if J < min_loss:
